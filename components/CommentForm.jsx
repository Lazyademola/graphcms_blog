...
const CommentForm = ({ slug }) => {
  ...
  return (
    <div className=' bg-white shadow-lg rounded-lg p-8 pb-12 mb-8'>
       <h3 className='text-xl mb-8 font-semibold border-b pb-4'>Drop A Thought</h3> 
      ...
      <div className='grid grid-cols-1 gap-4 mb-4'>
        <div>
          ...
          value="true"
          />
          <label className='text-gray-500 cursor-pointer ml-2'> Save my e-mail and name for when next I comment</label>
        </div>
      </div>
